...
#-----------------writeSalesOrderWithDetails-------------------------------
    ...
    def writeSalesOrderWithDetails(self, searchRowNum, getStockSheetDetail, getDayBookDetails):
        ...
        # print('searchRowNum', searchRowNum)
        # print(len(searchRowNum))
        # print(searchRowNum[0]['searchRowNum'])
        # #print('getStockSheetDetail', getStockSheetDetail)
        # print('getDayBookDetails', getDayBookDetails)
        ...
        if len(searchRowNum) > 0:
            ...
            for getDayBookDetailsRow in range(len(getDayBookDetails)):
                ...
                if countOfAvailQtyIfBatchQtyNotAvail <= getDayBookDetailsRow:
                    ...
                    # countQtyofItemList[0]['searchRowNum'].append(211)
                    # countQtyofItemList[0]['searchRowNumQty'].append(6)
                    # countQtyofItemList[0]['batchId'].append(202003)
        ...
        return salesOrderDetailsList, QtyNotAvailItems
                ...
                #     diffBatchQty = {}
                #     diffBatchQtylist = []
                #     #count the overall available qty in different batch
                #     overAllQty = sum(countQtyofItem['qty'])
                #     if overAllQty >= getDayBookDetails[getDayBookDetailsRow]['actualQuantity']:
                #         #store the batchId and Qty in seperate list with dict
                #         getActualQty = getDayBookDetails[getDayBookDetailsRow]['actualQuantity']
                #
                #         for countQtyofItemRow in range(len(countQtyofItem)):
                #             get = countQtyofItem['qty'][countQtyofItemRow]
                #
                #
                #     else:
                #         pass
        ...
        #                 stopLoopPrint += 1
        #                 if stopLoopPrint == 1:
        #                     print('Quantity for this partNumber is missing',getDayBookDetails[getDayBookDetailsRow]['itemCodeWithExtension'],  getDayBookDetails[getDayBookDetailsRow])
        #                 else:
        #                     pass
        #     return salesOrderDetails, CountOfRow
        ...
        # else:
        #     for stockSheetRow in range(len(searchRowNum)):
        #         getBatchId = self.stockSheet.cell(row=searchRowNum[stockSheetRow], column=6).value
        #         getGoodQty = self.stockSheet.cell(row=searchRowNum[stockSheetRow], column=11).value
        #
        #         if getGoodQty >= getDayBookDetails['actualQuantity']:
        #             if so.splitBatchId(getBatchId) >= '2019':
...
if __name__ == "__main__":
    ...
    # print('resultFromCreateData', resultFromCreateData[0])
    # print('')
    # print('')

    # print(resultFromCreateData)
    ...
    # print("DayBook", resultFromDaBookForItemCode)
    # print("StockBook", resultFromItemNameInStock)
    # # print("StockBook", resultFromItemNameInStock[0])
    #
    # if len(resultFromItemNameInStock[0]) != 0:
    #     print('Stock available in stock list')
    # else:
    #     print(resultFromDaBookForItemCode['itemName'], 'Unavailable')
    #
    # print(resultFromCreateData)
